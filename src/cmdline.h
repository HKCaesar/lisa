...
class ComandLine {
  public:
    ...
    void CreateMap(const std::string &str_ifile,const std::string &str_ofile,int reduction_factor,int map_scale,int map_type,int edge_effect_dept,const geoExtend &myExtend);
  private:
